...
class StaffBookingsRoutesTest : IntegrationTestSupport() {
    ...
    private fun latestBookingId(): Int =
        transaction {
            BookingTable
                .selectAll()
    ...
    private fun assignedSeatIdForBooking(bookingId: Int): Int? =
        transaction {
            val segmentId =
                BookingSegmentTable
    ...
    private fun segmentFlightIdForBooking(bookingId: Int): Int =
        transaction {
            BookingSegmentTable
                .select { BookingSegmentTable.bookingId eq bookingId }
                .limit(1)
    ...
    private fun seatStatus(seatId: Int): String =
        transaction {
            SeatTable
